...
type SvcClient interface {
	Send(context.Context, *google_protobuf1.StringValue, ...psrpc.RequestOpt) (*google_protobuf.Empty, error)
}
...
func (c *svcClient) Send(ctx context.Context, req *google_protobuf1.StringValue, opts ...psrpc.RequestOpt) (*google_protobuf.Empty, error) {
	return psrpc.RequestTopicSingle[*google_protobuf.Empty](ctx, c.client, "Send", "", req, opts...)
}
