...
func (c *svc2Client) Send(ctx context.Context, req *psrpc_internal_test_importable.Msg, opts ...psrpc.RequestOpt) (*psrpc_internal_test_importable.Msg, error) {
	return psrpc.RequestTopicSingle[*psrpc_internal_test_importable.Msg](ctx, c.client, "Send", "", req, opts...)
}
